...
def graph(request):
    return render(request, 'visualisation/line_chart.html')


#
# class ColorsView(TemplateView):
#     template_name = 'visualisation/colors.html'
#
...
# line_chart = TemplateView.as_view(template_name='visualisation/line_chart.html')
